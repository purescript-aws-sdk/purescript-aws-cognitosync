...
bulkPublish = Request.request service method  where
    service = Request.ServiceName "CognitoSync"
    method = Request.MethodName "bulkPublish"
...
deleteDataset = Request.request service method  where
    service = Request.ServiceName "CognitoSync"
    method = Request.MethodName "deleteDataset"
...
describeDataset = Request.request service method  where
    service = Request.ServiceName "CognitoSync"
    method = Request.MethodName "describeDataset"
...
describeIdentityPoolUsage = Request.request service method  where
    service = Request.ServiceName "CognitoSync"
    method = Request.MethodName "describeIdentityPoolUsage"
...
describeIdentityUsage = Request.request service method  where
    service = Request.ServiceName "CognitoSync"
    method = Request.MethodName "describeIdentityUsage"
...
getBulkPublishDetails = Request.request service method  where
    service = Request.ServiceName "CognitoSync"
    method = Request.MethodName "getBulkPublishDetails"
...
getCognitoEvents = Request.request service method  where
    service = Request.ServiceName "CognitoSync"
    method = Request.MethodName "getCognitoEvents"
...
getIdentityPoolConfiguration = Request.request service method  where
    service = Request.ServiceName "CognitoSync"
    method = Request.MethodName "getIdentityPoolConfiguration"
...
listDatasets = Request.request service method  where
    service = Request.ServiceName "CognitoSync"
    method = Request.MethodName "listDatasets"
...
listIdentityPoolUsage = Request.request service method  where
    service = Request.ServiceName "CognitoSync"
    method = Request.MethodName "listIdentityPoolUsage"
...
listRecords = Request.request service method  where
    service = Request.ServiceName "CognitoSync"
    method = Request.MethodName "listRecords"
...
registerDevice = Request.request service method  where
    service = Request.ServiceName "CognitoSync"
    method = Request.MethodName "registerDevice"
...
setCognitoEvents = Request.request service method  where
    service = Request.ServiceName "CognitoSync"
    method = Request.MethodName "setCognitoEvents"
...
setIdentityPoolConfiguration = Request.request service method  where
    service = Request.ServiceName "CognitoSync"
    method = Request.MethodName "setIdentityPoolConfiguration"
...
subscribeToDataset = Request.request service method  where
    service = Request.ServiceName "CognitoSync"
    method = Request.MethodName "subscribeToDataset"
...
unsubscribeFromDataset = Request.request service method  where
    service = Request.ServiceName "CognitoSync"
    method = Request.MethodName "unsubscribeFromDataset"
...
updateRecords = Request.request service method  where
    service = Request.ServiceName "CognitoSync"
    method = Request.MethodName "updateRecords"
